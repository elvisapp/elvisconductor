package com.optic.ubercloneconductor.activities;
...
import com.optic.ubercloneconductor.models.Info;
...
import com.optic.ubercloneconductor.providers.ClientProvider;
import com.optic.ubercloneconductor.providers.GeofireProvider;
import com.optic.ubercloneconductor.providers.GoogleApiProvider;
import com.optic.ubercloneconductor.providers.InfoProvider;
import com.optic.ubercloneconductor.providers.NotificationProvider;
import com.optic.ubercloneconductor.providers.TokenProvider;
import com.optic.ubercloneconductor.services.ForegroundService;
...
public class MapDriverBookingActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    //keytool -exportcert -alias androiddebugkey -keystore "C:\Users\jonat\.android\debug.keystore" | "C:\Users\jonat\Desktop\openssl\bin\openssl" sha1 -binary | "C:\Users\jonat\Desktop\openssl\bin\openssl" base64
        ...
        mGoogleApiProvider.getDirections(mCurrentLatLng, latLng).enqueue(new Callback<String>() {
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                try {
                    ...
                    Toast.makeText(MapDriverBookingActivity.this, "Error al trazar la ruta " + e.getMessage(), Toast.LENGTH_LONG).show();
                    Toast.makeText(MapDriverBookingActivity.this, "Conductor Lat: " + mCurrentLatLng.latitude, Toast.LENGTH_SHORT).show();
                    Toast.makeText(MapDriverBookingActivity.this, "Conductor Lng: " + mCurrentLatLng.longitude, Toast.LENGTH_SHORT).show();
                    Toast.makeText(MapDriverBookingActivity.this, "Lugar de recogida Lat: " + latLng.latitude, Toast.LENGTH_SHORT).show();
                    Toast.makeText(MapDriverBookingActivity.this, "Lugar de recogida Lng: " + latLng.longitude, Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (dataSnapshot.hasChild("token")) {
                        ...
                        Toast.makeText(MapDriverBookingActivity.this, "El cliente no tiene token de notificaciones", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
