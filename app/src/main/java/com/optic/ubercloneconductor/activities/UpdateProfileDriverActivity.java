...
import com.optic.ubercloneconductor.models.Driver;
import com.optic.ubercloneconductor.providers.AuthProvider;
import com.optic.ubercloneconductor.providers.DriverProvider;
import com.optic.ubercloneconductor.providers.ImagesProvider;
...
public class UpdateProfileDriverActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode== GALLERY_REQUEST && resultCode == RESULT_OK) {
            try {
                mImageFile = com.optic.ubercloneconductor.utils.FileUtil.from(this, data.getData());
